...
$
X_{k} = \sum_{n=0}^{N - 1}x_{n}e^{\frac{2pi}{N}kn} = \sum_{m=0}^{\frac{N}{2} - 1} x_{2m}e^{\frac{2pi}{N}k2m} + \sum_{m=0}^{\frac{N}{2} - 1} x_{2m + 1}e^{\frac{2pi}{N}k(2m+ 1)} =$
$ \sum_{m=0}^{M - 1} e_{m}e^{\frac{2pi}{M}km} + e^{\frac{2pi}{N}k} * \sum_{m=0}^{M - 1} o_{m}e^{\frac{2pi}{M}km} = $
$\begin{Bmatrix}
